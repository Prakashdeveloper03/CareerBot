...
heroText: Career Chatbot
tagline: Our career chatbot provides personalized guidance on courses, careers, and mentorship. Using advanced NLP, it suggests tailored courses, offers career insights, and provides one-on-one mentorship.
actions:
  - text: About
    icon: lightbulb
    link: ./demo/
